...
const TopCategoryHomeOne = () => {
  return (
    <>
      <section id="quiz" className="top-category section-padding">
        <div className="container">
          <div className="row g-4">
            <div className="col-lg-5">
              <div className="section-title">
                <h6 className="wow fadeInUp">Popular Fields</h6>
                <h2 className="wow fadeInUp" data-wow-delay=".3s">
                  Discover Your Perfect College & Degree Path
                </h2>
              </div>
              <p className="mt-3 mt-md-0 wow fadeInUp" data-wow-delay=".5s">
                Take our AI-powered quiz to discover colleges and degree
                programs that match your interests, skills, and career
